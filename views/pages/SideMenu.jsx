...
import { ALERT_PAGE, GRAPHITE_PAGE, TCP_PAGE } from "../common/Constants";
          ...
          <div className="custom-scrollbar">
            <nav id="sidenav" className="sidenav-collapse collapse">
              <ul className="sidenav">
                ...
                <MenuItem icon="icon-bar-chart-o" url="#" handleClick={() => {store.dispatch(openContentAction(alertID, GRAPHITE_PAGE))}} title="Graphite"/>
