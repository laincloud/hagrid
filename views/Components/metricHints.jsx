const METRIC_HINTS = [
    // Node metrics
    {value: "Node alive {0,1}", data: "isNonNull($node.ping.ping.<your>.<gateway>.<ip>.<address>)"},
    // CPU
    ...
    {value: "TCP :80 listening {0,1}", data: "$server.tcpconns.80-local.tcp_connections.LISTEN"},
