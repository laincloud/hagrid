...
func init() {
	apiNs := beego.NewNamespace("/api",
		...
		beego.NSNamespace("/alerts/:alert_id([0-9]+)/httpservices",
			beego.NSRouter("/", &controllers.HTTPServiceController{}, "post:Post"),
			beego.NSRouter("/test", &controllers.HTTPServiceController{}, "post:Test"),
			beego.NSRouter("/:https_id([0-9]+|all)", &controllers.HTTPServiceController{}, "get:Get"),
			beego.NSRouter("/:https_id([0-9]+)", &controllers.HTTPServiceController{}, "put:Put"),
			beego.NSRouter("/:https_id([0-9]+)", &controllers.HTTPServiceController{}, "delete:Delete"),
		),
